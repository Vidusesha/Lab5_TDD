...
contract StandardERC20 is IERC20 {
    ...
    function increaseallowance(address spender , uint256 addedValue) public returns(bool){
        require( _balances[msg.sender] >= addedValue , "ERC20:IncreaseAlwoance is not working");
        _approve(msg.sender , spender , _allowances[msg.sender][spender] + addedValue);
        return true;
    }

    function decreaseallowance(address spender , uint256 addedValue) public returns(bool){
        require( _balances[msg.sender] >= addedValue , "ERC20:DecreaseAlwoance is not working");
        _approve(msg.sender , spender , _allowances[msg.sender][spender] - addedValue);
        return true;
    }
